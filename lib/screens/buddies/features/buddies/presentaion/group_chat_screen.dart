...
class GroupChatScreen extends StatefulWidget {
  ...
  const GroupChatScreen({Key? key, this.model}) : super(key: key);
            ...
            children: [
              Consumer<ChatProvider>(
                ...
                builder: (context, provider, child) {
                  ...
                  if (provider.receivedGroupMessage != null) {
                    var msg = provider.receivedGroupMessage;
                    ...
                    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                      ...
                      if (msg!.groupId == widget.model!.groupId) {
                        setState(() {
                          isEmpty = false;
                              ...
                              ? GestureDetector(
                                  onTap: () async {
                                    if (_enterMessageController.text.toString().trim().isEmpty) {
                                      ...
                                      context.read<ChatProvider>().sendNewMsgToGroup(<Object>[
