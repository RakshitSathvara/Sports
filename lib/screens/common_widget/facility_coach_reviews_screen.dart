...
class FacilityCoachReviewScreen extends StatefulWidget {
  FacilityCoachReviewScreen({Key? key, required this.coachReviewList}) : super(key: key);
  CoachDetailsResponseModel coachReviewList;

  @override
  State<FacilityCoachReviewScreen> createState() => _FacilityCoachReviewScreenState();
}

class _FacilityCoachReviewScreenState extends State<FacilityCoachReviewScreen> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomTextView(
                    maxLine: 2,
                    label: '${widget.coachReviewList.coachName!} - ${widget.coachReviewList.name!} \nReviews',
                ...
                widget.coachReviewList.coachBookingReviews!.isNotEmpty
                    ? ListView.builder(
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount: widget.coachReviewList.coachBookingReviews!.length,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  CustomTextView(
                    label: widget.coachReviewList.coachBookingReviews![index].createdBy,
                  ...
                  CustomTextView(
                    label: widget.coachReviewList.coachBookingReviews![index].createdUserName,
              ...
              RatingBar.builder(
                initialRating: widget.coachReviewList.coachBookingReviews![index].rating!.toDouble(),
                minRating: 1,
                ignoreGestures: true,
          ...
          CustomTextView(
            label: widget.coachReviewList.coachBookingReviews![index].comment,
