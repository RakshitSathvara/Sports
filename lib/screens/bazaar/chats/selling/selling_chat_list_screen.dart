...
class SellingChatListScreen extends StatefulWidget {
  const SellingChatListScreen({super.key});

  @override
  State<SellingChatListScreen> createState() => SellingChatListScreenState();
}

class SellingChatListScreenState extends State<SellingChatListScreen> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void dispose() {
    print('Disposing SellingChatListScreen...');
  ...
  Future<void> _fetchChatList() async {
    ...
    try {
      debugPrint('Fetching selling chat list data...');
  ...
  Future<void> _refreshData() async {
    debugPrint('Refreshing selling chat list data...');
    setState(() {
      _chatList.clear();
      _pageStart = 0;
      _hasMoreData = true;
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          final intent = SellEquipmentResponseModel(
              ...
              sysUserId: chatItem.buyerId,
              equipmentCategoryId: 0,
              isEquipmentOwner: false,
              fullName: chatItem.buyerUserName,
              mobileNumber: '',
              email: '',
              userType: '',
              isFavourite: false,
